...
<body>
  ...
  <nav>
    <div class="topnav" id="myTopnav">
      <a href="https://prettywell.co.id/" id="logo"><img src="https://i.postimg.cc/Y9TX8zn2/icon-1.png" alt="LOGO "> <b>Logo.</b></a>
      ...
      <a href="javascript:void(0);" style="font-size:15px; padding-bottom: 10%;" class="icon" onclick="NavBar()">&#9776;</a>
    </div>
