  ...
  <div class="site">
    ...
    <div id="navbar">
      ...
      <div id="navbar-right">
        ...
        <a class="active" href="/aboutus">About</a>
    ...
    <header class="masthead">
      ...
      <section class="intro">
        <h1>Introduction</h1>
        <p>"Prettywell" a local beauty brand yang punya komitmen menciptakan produk yg touchable & 
          accessible. Sesuai dengan tagline Prettywell “you deserve skincare that works #prettywell”
          mendorong kita untuk selalu mengedepankan kualitas formulasi produknya, a very up-to-date 
          formulation yet AFFORDABLE. <br>
          <br> We build a very strong belive system within brand and customer. 
          We treat our customer as a human, not simply data.Kita punya yang namanya after sales experience 
          dengan melayani dan membantu customer achieve their skin goals with our expert beauty consultant. 
          Quality, efficacy, and maintaining customer trust must always be OUR priority.</p>      
      </section>
