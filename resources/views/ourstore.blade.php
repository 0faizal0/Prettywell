...
.masthead {
  padding: 15em 0;
  background-image: url("../img/store.jfif");
...
<body>
  ...
  <div class="site">
    ...
    <header class="masthead">
        ...
        <h1 class="masthead-heading">Our Store</h1>
      </header>
      <section class="intro">
        <h1>Online Store</h1>
      </section>
      <section class="where-Im-from">
        <a href="https://shopee.co.id/prettywell.co" target="_blank"><img src="../img/logoshop.png" alt="shopee" style="display: inline-block; width: 23%; height: 23%; margin-right: 20px;"></a>
        <a href="https://www.tokopedia.com/prettywellofficial" target="_blank"><img src="../img/tokpedlogo.png" alt="tokped" style="width: 70%; height: 70%; display: inline-block; margin-top: 40px;"></a>
        <a href="https://shopee.com.my/prettywell.co.my" target="_blank"><img src="../img/logoshop2.png" alt="shopee" style="width: 23%; height: 23%; margin-right: 20px; margin-top: 40px;"></a>
