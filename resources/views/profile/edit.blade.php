...
<body id="body-pd">
  ...
  <div>
    ...
    font-weight: 300; font-size: calc(1.375rem + 1.5vw); margin-top: 7%; font-family: sans-serif;">Profile</h1>
  </div>
  ...
  <div class="row d-flex justify-content-center">
      <div class="col-md-7">
          <div class="card p-3 py-4">
              <div class="text-center"> <img src="../uploads/avatars/{{ $user->avatar }}" width="100" class="rounded-circle">
