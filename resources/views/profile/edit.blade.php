...
<div>
    ...
    <h3 class="text-lg font-medium text-gray-900" style="position: relative; left: 11%; top: 120px;">Profile Picture</h3>
    <p class="mt-1 text-sm text-gray-600" style="position: relative; left: 11%; top: 120px;">
        Update your profile picture.
    </p>
    <div class="bg-white shadow rounded-lg" style=" margin-left: 37%; margin-right: 10%; margin-bottom: 1%; margin-top: 1%; height: 250px;">
    ...
    <h3 class="text-lg font-medium text-gray-900" style="position: relative; left: 11%; top: 120px;">Profile Information</h3>
    <p class="mt-1 text-sm text-gray-600" style="position: relative; left: 11%; top: 120px;">
    Update your account's profile information and <br> email address.
    </p>

                <div class="bg-white shadow rounded-lg" style=" margin-left: 37%; margin-right: 10%; margin-bottom: 1%; margin-top: 1%; height: 280px; overflow: hidden;">
