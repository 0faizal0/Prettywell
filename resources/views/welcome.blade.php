...
{{-- <div id='content'>
  <div class='container'>
    ...
    <div class="header">
      ...
      <hr style="width: 50%; color: #130d0a; background-color: #130d0a; height: 3px; margin-left: auto; margin-right: auto; position: relative; bottom: 50px;" data-aos="fade-up" data-aos-duration="1500">
            ...
            <div class="aboutus" id="aboutus">
              ...
              <p id="about" data-aos="fade-up">We created this website for our community to communicate <br> through the website,
                build our community <br> more solid with chat system, <br> and give us some updates
    ...
    <!-- First Photo Grid-->
    <div style="background-color: #130d0a; width: 100%; height: 2100px;">
